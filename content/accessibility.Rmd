...
Training courses provided by Visible Data utilise a number of different technologies and are a mix of lecture, live coding and group work exercises. The following notes may not apply to all training courses, we will provide an accessiblity statement for all booked training courses.
...
Jonathan Godfrey has published a set of recommendations for immproving the accessibility of content created with RMarkdown, https://r-resources.massey.ac.nz/rmarkdown/. Visible Data comits to following these recommendations.
...
Please do contact us regardinging lecture slide content that is not yet accessible for you and we will endeavour to provide adaptations for your needs.
...
At present, our website remains inaccessible to a large number of individuals. We use Nomensa's [Accessibility Statement Generator](https://www.accessibilitystatementgenerator.com/) for rating our web content. Our aim is for the website to satisfy the conditions for an 'A' accessiblity grade.  

Here at the current issues which prevent us from receiving an 'A' grading:
