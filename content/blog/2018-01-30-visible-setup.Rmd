...
1. Navigate to `layouts/partials/footer.html` and modify the top 6 lines so they read as follows, which will only insert the Disqus comments section to blogposts!
<pre>
&lt;footer id="footer"&gt;
    &lt;div class="container"&gt;
