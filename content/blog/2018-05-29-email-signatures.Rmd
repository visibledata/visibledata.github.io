...
💥 [TimeZoneNinja](http://timezoneninja.com/) will help if we inhabit different timez-ones 💥 

## Data-driven Signature Design

 {#data-driven-design}I've personally worked for several years in industry and know how often marketing folks fuss about the beauty of their email signatures, but typically they don't collect data to iterate on the signature and create an effective marketing tool. 
...
## Contact info and social media links
 ...
 {#social-contacts}All our signatures include the following contact details:
...
## Reproducibility
 ...
 {#reproducibility}Visible Data currently uses [GSuite](https://gsuite.google.com/) to power our business, it provides our email and cloud-based storage. There are a few utilities that would allow us to programmatically modify our signatures but they are prohibitively expensive at the moment.
